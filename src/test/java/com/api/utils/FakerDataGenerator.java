...
//Util class
	...
	private static Faker faker = new Faker(new Locale("en-IND")); // Help me create India specific fake data
	...
	public static CreateJobPayload generateFakeCreateJobData() {
		Customer customer = generateFakeCusomerData();
	...
	private static Customer generateFakeCusomerData() {
		String fname = faker.name().firstName();
		String lname = faker.name().lastName();
		String mobileNumber = faker.numerify("90########");
		String alternateMobileNumber = faker.numerify("90########");
